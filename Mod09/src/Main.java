...
public class Main{
    ...
    private static final SykkelLager sykkelLager = new SykkelLager();

    public static void main(String[] args)
    {
        sykkelLager.addSykkelToLager("red",2,5500,6,150,1,"29.10.17");
        sykkelLager.addSykkelToLager("blue",1,10000,4,200,3,"05.01.18");
        ...
        sykkelLager.printSykkelldyrereEnn(5500);
    }
